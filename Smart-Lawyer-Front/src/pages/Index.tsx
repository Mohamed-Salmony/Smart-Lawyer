      ...
      <div className="min-h-screen bg-darknavy text-white">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 text-right mb-8 md:mb-0">
              ...
              <div className="flex flex-col sm:flex-row justify-end space-y-4 sm:space-y-0 sm:space-x-4 sm:space-x-reverse">
                <Link to="/upload">
                  <Button className="bg-gold text-black hover:bg-amber-400 w-full sm:w-auto">
                    <FileText className="ml-2" size={20} />
                    {language === 'ar' ? 'رفع مستند جديد' : 'Upload New Document'}
                  </Button>
                </Link>
                <Link to="/analysis">
                  <Button className="bg-darkgray text-gold hover:bg-gray-600 w-full sm:w-auto">
        ...
        <div className="bg-navy py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-gold">{language === 'ar' ? 'مزايا المنصة' : 'Platform Features'}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-darknavy p-6 rounded-lg shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold mb-2">{language === 'ar' ? 'تحليل سريع ودقيق' : 'Fast and Accurate Analysis'}</h3>
              ...
              <div className="bg-darknavy p-6 rounded-lg shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold mb-2">{language === 'ar' ? 'بحث ذكي في السوابق' : 'Smart Precedent Search'}</h3>
              ...
              <div className="bg-darknavy p-6 rounded-lg shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold mb-2">{language === 'ar' ? 'صياغة قانونية احترافية' : 'Professional Legal Drafting'}</h3>
        ...
        {/* CTA Section */}
        <div className="container mx-auto px-4 py-16">
          <div className="bg-navy rounded-lg p-8 shadow-lg text-center">
            <h2 className="text-2xl font-bold mb-4 text-gold">{language === 'ar' ? 'ابدأ اليوم في استخدام الذكاء الاصطناعي لتعزيز عملك القانوني' : 'Start using AI today to enhance your legal work'}</h2>
            ...
            <Link to="/register">
              <Button className="bg-gold text-black hover:bg-amber-400 text-lg py-3 px-10">
